...
- One JSON Schema file per contract, e.g. `config.schema.json`, `usage-snapshot.schema.json`, `live-report.schema.json`, `widget-snapshot.schema.json`, `event.schema.json`, `session-record.schema.json`, `supervisor-state.schema.json`.
